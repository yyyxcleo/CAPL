    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        if image_mask_positions is not None:
            ...
            image_only_diag = torch.zeros_like(causal_mask)
            image_only_diag[image_mask_positions, image_mask_positions] = True
            total_mask = causal_mask.clone()
            total_mask[image_mask_positions.unsqueeze(1), image_mask_positions.unsqueeze(0)] = False
            total_mask = total_mask | image_only_diag
...
class Qwen2_5_VLModel(Qwen2_5_VLPreTrainedModel):
    ...
    def get_placeholder_mask(
        ...
        ####
        image_mask_positions = torch.nonzero(special_image_mask, as_tuple=False)[:,1]
        ####
